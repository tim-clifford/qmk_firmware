...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
	[_CTL] = LAYOUT(
	TT(_QWERTY), _______, _______, _______, _______, _______, _______,                           _______, _______, _______, _______, _______, _______, KC_HOME, \
...
key_override_t key_override_1 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_EXLM, UK_1,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_3 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, S(UK_3), UK_3,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_5 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_PERC, UK_5,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_7 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_AMPR, UK_7,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_9 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_LBRC, UK_9,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_L = ko_make_with_layers_negmods_and_options(MOD_MASK_SHIFT,UK_LPRN, UK_LBRC, 1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_R = ko_make_with_layers_negmods_and_options(MOD_MASK_SHIFT,UK_RPRN, UK_RBRC, 1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod); // results in curly since shift is pressed
key_override_t key_override_0 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_RBRC, UK_0,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_2 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_AT,   UK_2,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_4 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_DLR,  UK_4,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_6 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_CIRC, UK_6,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_8 = ko_make_with_layers_negmods_and_options(MOD_MASK_CSAG, UK_ASTR, UK_8,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod);
key_override_t key_override_Q = ko_make_with_layers_negmods_and_options(MOD_MASK_SHIFT,UK_QUOT, UK_2,    1<<_US|1<<_NORMAL, 0, ko_options_default | ko_option_one_mod); // results in @ since shift is pressed
